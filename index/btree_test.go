...
func Test_BTree_Put(t *testing.T) {
    ...
    res2 := bt.Put([]byte("x"), &data.LogRecordPos{Fid: 1, Offset: 2})
    assert.True(t, res2)
}
...
func Test_BTree_Get(t *testing.T) {
    ...
    res2 := bt.Put([]byte("x"), &data.LogRecordPos{Fid: 1, Offset: 2})
    assert.True(t, res2)
    res3 := bt.Put([]byte("x"), &data.LogRecordPos{Fid: 2, Offset: 3})
    assert.True(t, res3)
    pos3 :=  bt.Get([]byte("x"))
...
func Test_BTree_Delete(t *testing.T) {
    ...
    res4 := bt.Put([]byte("abc"), &data.LogRecordPos{Fid: 2, Offset: 2})
    assert.True(t, res4)
